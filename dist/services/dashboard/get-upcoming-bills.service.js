...
class GetUpcomingBillsService {
    async execute({ workspaceId }) {
        ...
        const realTransactions = await prisma_1.prisma.transaction.findMany({
            where: {
                workspaceId,
                type: client_1.TransactionType.EXPENSE,
                paymentMethod: {
                    not: client_1.TransactionPaymentMethod.CREDIT_CARD, // Ignora cartão (fatura)
                },
                date: {
                    gte: today, // De hoje...
        ...
        const recurringCandidates = await prisma_1.prisma.recurringTransaction.findMany({
            where: {
                workspaceId,
                type: client_1.TransactionType.EXPENSE,
                paymentMethod: {
                    not: client_1.TransactionPaymentMethod.CREDIT_CARD,
                },
...
exports.GetUpcomingBillsService = GetUpcomingBillsService;
